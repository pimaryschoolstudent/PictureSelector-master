...
public class CustomCameraView extends RelativeLayout {
    ...
    public void initView() {
        ...
        setBackgroundColor(ContextCompat.getColor(getContext(), MResource.getIdentifier(getContext(),"color","picture_color_black")));
        View view = LayoutInflater.from(getContext()).inflate(MResource.getIdentifier(getContext(),"layout","picture_camera_view"), this);
        mCameraView = view.findViewById(MResource.getIdentifier(getContext(),"id","cameraView"));
        mCameraView.enableTorch(true);
        mTextureView = view.findViewById(MResource.getIdentifier(getContext(),"id","video_play_preview"));
        mImagePreview = view.findViewById(MResource.getIdentifier(getContext(),"id","image_preview"));
        mSwitchCamera = view.findViewById(MResource.getIdentifier(getContext(),"id","image_switch"));
        mSwitchCamera.setImageResource(MResource.getIdentifier(getContext(),"drawable","picture_ic_camera"));
        mFlashLamp = view.findViewById(MResource.getIdentifier(getContext(),"id","image_flash"));
        setFlashRes();
        ...
        mCaptureLayout = view.findViewById(MResource.getIdentifier(getContext(),"id","capture_layout"));
        ...
        mCaptureLayout.setCaptureListener(new CaptureListener() {
            ...
            public void recordShort(final long time) {
                ...
                mCaptureLayout.setTextWithAnimation(getContext().getString(MResource.getIdentifier(getContext(),"string","picture_recording_time_is_short")));
    ...
    private void setFlashRes() {
        switch (type_flash) {
            case TYPE_FLASH_AUTO:
                mFlashLamp.setImageResource(MResource.getIdentifier(getContext(),"drawable","picture_ic_flash_auto"));
                mCameraView.setFlash(ImageCapture.FLASH_MODE_AUTO);
                break;
            case TYPE_FLASH_ON:
                mFlashLamp.setImageResource(MResource.getIdentifier(getContext(),"drawable","picture_ic_flash_on"));
                mCameraView.setFlash(ImageCapture.FLASH_MODE_ON);
                break;
            case TYPE_FLASH_OFF:
                mFlashLamp.setImageResource(MResource.getIdentifier(getContext(),"drawable","picture_ic_flash_off"));
