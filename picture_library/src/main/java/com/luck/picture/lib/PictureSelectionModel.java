...
public class PictureSelectionModel {
     ...
     */
    @Deprecated
    public PictureSelectionModel setPictureStyle(PictureParameterStyle style, Context mcontext) {
        if (style != null) {
            ...
            PictureSelectionConfig.style = PictureParameterStyle.ofDefaultStyle(mcontext);
        }
        return this;
    }
