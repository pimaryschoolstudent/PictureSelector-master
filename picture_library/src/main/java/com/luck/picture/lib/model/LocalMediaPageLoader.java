                    ...
                    if (data != null) {
                        ...
                        if (count > 0) {
                            ...
                            String bucketDisplayName = config.chooseMode == PictureMimeType.ofAudio() ?
                                    mContext.getString(MResource.getIdentifier(mContext,"string","picture_all_audio"))
                                    : mContext.getString(MResource.getIdentifier(mContext,"string","picture_camera_roll"));
