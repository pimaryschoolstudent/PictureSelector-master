...
public class StringUtils {
    ...
    public static void tempTextFont(TextView tv, int mimeType) {
        ...
        String str = mimeType == PictureMimeType.ofAudio() ?
                tv.getContext().getString(MResource.getIdentifier(tv.getContext(),"string","picture_empty_audio_title"))
                : tv.getContext().getString(MResource.getIdentifier(tv.getContext(),"string","picture_empty_title"));
    ...
    public static String getMsg(Context context, String mimeType, int maxSelectNum) {
        if (PictureMimeType.isHasVideo(mimeType)) {
            return context.getString(MResource.getIdentifier(context,"string","picture_message_video_max_num"), maxSelectNum);
        } else if (PictureMimeType.isHasAudio(mimeType)) {
            return context.getString(MResource.getIdentifier(context,"string","picture_message_audio_max_num"), maxSelectNum);
        } else {
            return context.getString(MResource.getIdentifier(context,"string","picture_message_max_num"), maxSelectNum);
        }
    }
