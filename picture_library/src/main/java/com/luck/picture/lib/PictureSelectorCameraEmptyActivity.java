...
public class PictureSelectorCameraEmptyActivity extends PictureBaseActivity {
    ...
    public void immersive() {
        ImmersiveManage.immersiveAboveAPI23(this
                , ContextCompat.getColor(this, MResource.getIdentifier(getContext(),"color","picture_color_transparent"))
                , ContextCompat.getColor(this, MResource.getIdentifier(getContext(),"color","picture_color_transparent"))
                , openWhiteStatusBar);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!config.isUseCustomCamera) {
            ...
            setTheme(MResource.getIdentifier(getContext(),"style","Picture_Theme_Translucent"));
        }
    }
    ...
    public int getResourceId() {
        return MResource.getIdentifier(getContext(),"layout","picture_empty");
    }
        ...
        switch (requestCode) {
            ...
            case PictureConfig.APPLY_CAMERA_PERMISSIONS_CODE:
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    exit();
                    ToastUtils.s(getContext(), getString(MResource.getIdentifier(getContext(),"string","picture_camera")));
                }
                break;
