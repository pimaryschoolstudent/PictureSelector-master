...
public class PicturePreviewActivity extends PictureBaseActivity implements
    ...
    public int getResourceId() {
        return MResource.getIdentifier(getContext(),"layout","picture_preview");
    }
    ...
    protected void initWidgets() {
        ...
        pictureLeftBack = findViewById(MResource.getIdentifier(getContext(),"id","pictureLeftBack"));
        ...
        viewPager = findViewById(MResource.getIdentifier(getContext(),"id","preview_pager"));
        mPicturePreview = findViewById(MResource.getIdentifier(getContext(),"id","picture_id_preview"));
        btnCheck = findViewById(MResource.getIdentifier(getContext(),"id","btnCheck"));
        check = findViewById(MResource.getIdentifier(getContext(),"id","check"));
        ...
        tvMediaNum = findViewById(MResource.getIdentifier(getContext(),"id","tv_media_num"));
        selectBarLayout = findViewById(MResource.getIdentifier(getContext(),"id","select_bar_layout"));
        mTvPictureOk.setOnClickListener(this);
        tvMediaNum.setOnClickListener(this);
        tvTitle = findViewById(MResource.getIdentifier(getContext(),"id","picture_title"));
            ...
            if (startCount <= 0) {
                ...
                if (PictureSelectionConfig.uiStyle != null) {
                    ...
                    mTvPictureOk.setText(!TextUtils.isEmpty(PictureSelectionConfig.style.pictureUnCompleteText)
                            ? PictureSelectionConfig.style.pictureUnCompleteText : getString(MResource.getIdentifier(getContext(),"string","picture_please_select")));
                }
            } else {
                // 已选择
                if (PictureSelectionConfig.uiStyle != null) {
            ...
            if (startCount <= 0) {
                ...
                if (PictureSelectionConfig.uiStyle != null) {
                    mTvPictureOk.setText(PictureSelectionConfig.uiStyle.isCompleteReplaceNum && PictureSelectionConfig.uiStyle.picture_bottom_completeDefaultText != 0
                            ? String.format(getString(PictureSelectionConfig.uiStyle.picture_bottom_completeDefaultText), startCount, config.maxSelectNum) : getString(MResource.getIdentifier(getContext(),"string","picture_done_front_num"),
                    ...
                    mTvPictureOk.setText(PictureSelectionConfig.style.isCompleteReplaceNum && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureUnCompleteText)
                            ? PictureSelectionConfig.style.pictureUnCompleteText : getString(MResource.getIdentifier(getContext(),"string","picture_done_front_num"),
                            startCount, config.maxSelectNum));
                }
            } else {
                // 已选择
        ...
        if (PictureSelectionConfig.uiStyle != null) {
            ...
            if (config.isOriginalControl) {
                ...
                if (PictureSelectionConfig.uiStyle.picture_bottom_originalPictureTextColor != 0) {
                    ...
                    mCbOriginal.setTextColor(ContextCompat.getColor(this, MResource.getIdentifier(getContext(),"color","picture_color_53575e")));
                }
            ...
            Drawable pictureCheckedStyle = AttrsUtils.getTypeValueDrawable(getContext(), MResource.getIdentifier(getContext(),"attr","picture_checked_style"), MResource.getIdentifier(getContext(),"drawable","picture_checkbox_selector"));
            check.setBackground(pictureCheckedStyle);
            ColorStateList completeColorStateList = AttrsUtils.getTypeValueColorStateList(getContext(), MResource.getIdentifier(getContext(),"attr","picture_ac_preview_complete_textColor"));
            if (completeColorStateList != null) {
                mTvPictureOk.setTextColor(completeColorStateList);
            }
            Drawable leftDrawable = AttrsUtils.getTypeValueDrawable(getContext(), MResource.getIdentifier(getContext(),"attr","picture_preview_leftBack_icon"), MResource.getIdentifier(getContext(),"drawable","picture_icon_back"));
            pictureLeftBack.setImageDrawable(leftDrawable);

            int titleColor = AttrsUtils.getTypeValueColor(getContext(), MResource.getIdentifier(getContext(),"attr","picture_ac_preview_title_textColor"));
            if (titleColor != 0) {
            ...
            int previewBottomBgColor = AttrsUtils.getTypeValueColor(getContext(), MResource.getIdentifier(getContext(),"attr","picture_ac_preview_bottom_bg"));
    ...
    private void setTitle() {
        if (config.isPageStrategy && !isBottomPreview) {
            tvTitle.setText(getString(MResource.getIdentifier(getContext(),"string","picture_preview_image_num"),
        ...
        if (enable) {
            ...
            if (PictureSelectionConfig.style != null) {
                if (PictureSelectionConfig.style.pictureCompleteTextColor != 0) {
                    ...
                    mTvPictureOk.setTextColor(ContextCompat.getColor(getContext(), MResource.getIdentifier(getContext(),"color","picture_color_fa632d")));
                }
            }
            if (numComplete) {
            ...
            if (PictureSelectionConfig.style != null) {
                if (PictureSelectionConfig.style.pictureUnCompleteTextColor != 0) {
                    ...
                    mTvPictureOk.setTextColor(ContextCompat.getColor(getContext(), MResource.getIdentifier(getContext(),"color", "picture_color_9b")));
                }
            }
            if (numComplete) {
                initCompleteText(0);
    ...
    public void onClick(View view) {
        ...
        if (id == MResource.getIdentifier(getContext(),"id","pictureLeftBack")) {
            onBackPressed();
        } else if (id == MResource.getIdentifier(getContext(),"id","picture_tv_ok") || id == MResource.getIdentifier(getContext(),"id","tv_media_num")) {
            onComplete();
        } else if (id == MResource.getIdentifier(getContext(),"id","btnCheck")) {
            onCheckedComplete();
        }
    }
            ...
            if (config.isWithVideoImage) {
                ...
                if (PictureMimeType.isHasVideo(image.getMimeType())) {
                    ...
                    if (currentSize >= config.maxSelectNum && !check.isSelected()) {
                        showPromptDialog(getString(MResource.getIdentifier(getContext(),"string","picture_message_max_num"), config.maxSelectNum));
                        return;
                    }
                    ...
                    if (!check.isSelected() && config.videoMinSecond > 0 && image.getDuration() < config.videoMinSecond) {
                        // 视频小于最低指定的长度
                        showPromptDialog(getContext().getString(MResource.getIdentifier(getContext(),"string","picture_choose_min_seconds"), config.videoMinSecond / 1000));
                        return;
                    }

                    if (!check.isSelected() && config.videoMaxSecond > 0 && image.getDuration() > config.videoMaxSecond) {
                        // 视频时长超过了指定的长度
                        showPromptDialog(getContext().getString(MResource.getIdentifier(getContext(),"string","picture_choose_max_seconds"), config.videoMaxSecond / 1000));
                        return;
                    }
                } else {
                    if (currentSize >= config.maxSelectNum && !check.isSelected()) {
