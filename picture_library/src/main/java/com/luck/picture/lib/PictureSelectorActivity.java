...
public class PictureSelectorActivity extends PictureBaseActivity implements View.OnClickListener,
    ...
    protected void onResume() {
        ...
        if (isEnterSetting) {
            if (PermissionChecker
                ...
                showPermissionsDialog(false, getString(MResource.getIdentifier(getContext(),"string","picture_jurisdiction")));
            }
    ...
    public int getResourceId() {
        return MResource.getIdentifier(getContext(),"layout","picture_selector");
    }

    @Override
    protected void initWidgets() {
        super.initWidgets();
        container = findViewById(MResource.getIdentifier(getContext(),"id","container"));
        mTitleBar = findViewById(MResource.getIdentifier(getContext(),"id","titleBar"));
        mIvPictureLeftBack = findViewById(MResource.getIdentifier(getContext(),"id","pictureLeftBack"));
        mTvPictureTitle = findViewById(MResource.getIdentifier(getContext(),"id","picture_title"));
        mTvPictureRight = findViewById(MResource.getIdentifier(getContext(),"id","picture_right"));
        mTvPictureOk = findViewById(MResource.getIdentifier(getContext(),"id","picture_tv_ok"));
        mCbOriginal = findViewById(MResource.getIdentifier(getContext(),"id","cb_original"));
        mIvArrow = findViewById(MResource.getIdentifier(getContext(),"id","ivArrow"));
        viewClickMask = findViewById(MResource.getIdentifier(getContext(),"id","viewClickMask"));
        mTvPicturePreview = findViewById(MResource.getIdentifier(getContext(),"id","picture_id_preview"));
        mTvPictureImgNum = findViewById(MResource.getIdentifier(getContext(),"id","tv_media_num"));
        mRecyclerView = findViewById(MResource.getIdentifier(getContext(),"id","picture_recycler"));
        mBottomLayout = findViewById(MResource.getIdentifier(getContext(),"id","select_bar_layout"));
        mTvEmpty = findViewById(MResource.getIdentifier(getContext(),"id","tv_empty"));
        isNumComplete(numComplete);
        if (!numComplete) {
            animation = AnimationUtils.loadAnimation(this, MResource.getIdentifier(getContext(),"anim","picture_anim_modal_in"));
        }
        ...
        String title = config.chooseMode == PictureMimeType.ofAudio() ?
                getString(MResource.getIdentifier(getContext(),"string","picture_all_audio")) : getString(MResource.getIdentifier(getContext(),"string","picture_camera_roll"));
        mTvPictureTitle.setText(title);
        mTvPictureTitle.setTag(MResource.getIdentifier(getContext(),"id","view_tag"), -1);
        ...
        mTvEmpty.setText(config.chooseMode == PictureMimeType.ofAudio() ?
                getString(MResource.getIdentifier(getContext(),"string","picture_audio_empty"))
                : getString(MResource.getIdentifier(getContext(),"string","picture_empty")));
    ...
    private int getPageLimit() {
        int bucketId = ValueOf.toInt(mTvPictureTitle.getTag(MResource.getIdentifier(getContext(),"id","view_tag")));
        if (bucketId == -1) {
    ...
    private void loadMoreData() {
        if (mAdapter != null) {
            if (isHasMore) {
                mPage++;
                long bucketId = ValueOf.toLong(mTvPictureTitle.getTag(MResource.getIdentifier(getContext(),"id","view_tag")));
                        ...
                        (OnQueryDataResultListener<LocalMedia>) (result, currentPage, isHasMore) -> {
                            if (!isFinishing()) {
                                ...
                                if (isHasMore) {
                                    ...
                                    if (isEmpty) {
                                        showDataNull(bucketId == -1 ? getString(MResource.getIdentifier(getContext(),"string","picture_empty")) : getString(MResource.getIdentifier(getContext(),"string","picture_data_null")), MResource.getIdentifier(getContext(),"drawable","drawable"));
                                    }
                                }
                            }
                        });
        ...
        if (PictureSelectionConfig.uiStyle != null) {
            ...
            if (config.isOriginalControl) {
                if (PictureSelectionConfig.uiStyle.picture_bottom_originalPictureCheckStyle != 0) {
                    ...
                    mCbOriginal.setButtonDrawable(ContextCompat.getDrawable(this, MResource.getIdentifier(getContext(),"drawable","picture_original_checkbox")));
                }
                if (PictureSelectionConfig.uiStyle.picture_bottom_originalPictureTextColor != 0) {
                    ...
                    mCbOriginal.setTextColor(ContextCompat.getColor(this, MResource.getIdentifier(getContext(),"color","picture_color_white")));
                }
            ...
            int titleColor = AttrsUtils.getTypeValueColor(getContext(), MResource.getIdentifier(getContext(),"attr","picture_title_textColor"));
            if (titleColor != 0) {
                mTvPictureTitle.setTextColor(titleColor);
            }
            int rightTitleColor = AttrsUtils.getTypeValueColor(getContext(), MResource.getIdentifier(getContext(),"attr","picture_right_textColor"));
            if (rightTitleColor != 0) {
                mTvPictureRight.setTextColor(rightTitleColor);
            }
            int containerBackgroundColor = AttrsUtils.getTypeValueColor(getContext(), MResource.getIdentifier(getContext(),"attr","picture_container_backgroundColor"));
            if (containerBackgroundColor != 0) {
                container.setBackgroundColor(containerBackgroundColor);
            }
            Drawable leftDrawable = AttrsUtils.getTypeValueDrawable(getContext(), MResource.getIdentifier(getContext(),"attr","picture_leftBack_icon"), MResource.getIdentifier(getContext(),"drawable","picture_icon_back"));
            ...
            if (config.downResId != 0) {
                ...
                Drawable downDrawable = AttrsUtils.getTypeValueDrawable(getContext(), MResource.getIdentifier(getContext(),"attr","picture_arrow_down_icon"), MResource.getIdentifier(getContext(),"drawable","picture_icon_arrow_down"));
                mIvArrow.setImageDrawable(downDrawable);
            }
            int pictureBottomBgColor = AttrsUtils.getTypeValueColor(getContext(), MResource.getIdentifier(getContext(),"attr","picture_bottom_bg"));
            if (pictureBottomBgColor != 0) {
                mBottomLayout.setBackgroundColor(pictureBottomBgColor);
            }
            ColorStateList completeColorStateList = AttrsUtils.getTypeValueColorStateList(getContext(), MResource.getIdentifier(getContext(),"attr","picture_complete_textColor"));
            if (completeColorStateList != null) {
                mTvPictureOk.setTextColor(completeColorStateList);
            }
            ColorStateList previewColorStateList = AttrsUtils.getTypeValueColorStateList(getContext(), MResource.getIdentifier(getContext(),"attr","picture_preview_textColor"));
            if (previewColorStateList != null) {
                mTvPicturePreview.setTextColor(previewColorStateList);
            }
            int pictureTitleRightArrowLeftPadding = AttrsUtils.getTypeValueSizeForInt(getContext(), MResource.getIdentifier(getContext(),"attr","picture_titleRightArrow_LeftPadding"));
            if (pictureTitleRightArrowLeftPadding != 0) {
                RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mIvArrow.getLayoutParams();
                params.leftMargin = pictureTitleRightArrowLeftPadding;
            }
            Drawable ovalBgDrawable = AttrsUtils.getTypeValueDrawable(getContext(),MResource.getIdentifier(getContext(),"attr","picture_num_style"), MResource.getIdentifier(getContext(),"drawable","picture_num_oval"));
            mTvPictureImgNum.setBackground(ovalBgDrawable);

            int titleBarHeight = AttrsUtils.getTypeValueSizeForInt(getContext(), MResource.getIdentifier(getContext(),"attr","picture_titleBar_height"));
            if (titleBarHeight > 0) {
                ViewGroup.LayoutParams params = mTitleBar.getLayoutParams();
                params.height = titleBarHeight;
            }
            if (config.isOriginalControl) {
                Drawable originalDrawable = AttrsUtils.getTypeValueDrawable(getContext(), MResource.getIdentifier(getContext(),"attr","picture_original_check_style"), MResource.getIdentifier(getContext(),"drawable","picture_original_wechat_checkbox"));
                mCbOriginal.setButtonDrawable(originalDrawable);
                int originalTextColor = AttrsUtils.getTypeValueColor(getContext(), MResource.getIdentifier(getContext(),"attr","picture_original_text_color"));
...
//        mTitleBar.setBackgroundColor(colorPrimary);
                ...
                if (PictureSelectionConfig.uiStyle != null) {
                    if (PictureSelectionConfig.uiStyle.isCompleteReplaceNum) {
                        mTvPictureOk.setText(PictureSelectionConfig.uiStyle.picture_bottom_completeDefaultText != 0
                                ? String.format(getString(PictureSelectionConfig.uiStyle.picture_bottom_completeDefaultText), startCount, 1) : getString(MResource.getIdentifier(getContext(),"string","picture_please_select")));
                    } else {
                        mTvPictureOk.setText(PictureSelectionConfig.uiStyle.picture_bottom_completeDefaultText != 0
                                ? getString(PictureSelectionConfig.uiStyle.picture_bottom_completeDefaultText) : getString(MResource.getIdentifier(getContext(),"string","picture_please_select")));
                    }
                } else if (PictureSelectionConfig.style != null) {
                    if (PictureSelectionConfig.style.isCompleteReplaceNum && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureUnCompleteText)) {
                        ...
                        mTvPictureOk.setText(!TextUtils.isEmpty(PictureSelectionConfig.style.pictureUnCompleteText)
                                ? PictureSelectionConfig.style.pictureUnCompleteText : getString(MResource.getIdentifier(getContext(),"string","picture_done")));
                    }
                }
            } else {
                if (PictureSelectionConfig.uiStyle != null) {
                    if (PictureSelectionConfig.uiStyle.isCompleteReplaceNum) {
                        mTvPictureOk.setText(PictureSelectionConfig.uiStyle.picture_bottom_completeNormalText != 0
                                ? String.format(getString(PictureSelectionConfig.uiStyle.picture_bottom_completeNormalText), startCount, 1) : getString(MResource.getIdentifier(getContext(),"string","picture_done")));
                    } else {
                        mTvPictureOk.setText(PictureSelectionConfig.uiStyle.picture_bottom_completeNormalText != 0
                                ? getString(PictureSelectionConfig.uiStyle.picture_bottom_completeNormalText) : getString(MResource.getIdentifier(getContext(),"string","picture_done")));
                    }
                } else if (PictureSelectionConfig.style != null) {
                    if (PictureSelectionConfig.style.isCompleteReplaceNum && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureCompleteText)) {
                        ...
                        mTvPictureOk.setText(!TextUtils.isEmpty(PictureSelectionConfig.style.pictureCompleteText)
                                ? PictureSelectionConfig.style.pictureCompleteText : getString(MResource.getIdentifier(getContext(),"string","picture_done")));
                    }
                }
            }
                ...
                if (PictureSelectionConfig.uiStyle != null) {
                    if (PictureSelectionConfig.uiStyle.isCompleteReplaceNum) {
                        mTvPictureOk.setText(PictureSelectionConfig.uiStyle.picture_bottom_completeDefaultText != 0
                                ...
                                getString(MResource.getIdentifier(getContext(),"string","picture_done_front_num"), startCount, config.maxSelectNum));
                    } else {
                        mTvPictureOk.setText(PictureSelectionConfig.uiStyle.picture_bottom_completeDefaultText != 0
                ...
                if (PictureSelectionConfig.uiStyle != null) {
                    ...
                    if (PictureSelectionConfig.uiStyle.isCompleteReplaceNum) {
                        if (PictureSelectionConfig.uiStyle.picture_bottom_completeNormalText != 0) {
                            ...
                            mTvPictureOk.setText(getString(MResource.getIdentifier(getContext(),"string","picture_done_front_num"), startCount, config.maxSelectNum));
                        }
                    } else {
                        if (PictureSelectionConfig.uiStyle.picture_bottom_completeNormalText != 0) {
    ...
    private void initPageModel(List<LocalMediaFolder> folders) {
        if (folders != null) {
            ...
            mTvPictureTitle.setTag(MResource.getIdentifier(getContext(),"id","view_count_tag"), folder != null ? folder.getImageNum() : 0);
            mTvPictureTitle.setTag(MResource.getIdentifier(getContext(),"id","view_index_tag"), 0);
                    ...
                    (OnQueryDataResultListener<LocalMedia>) (data, currentPage, isHasMore) -> {
                        if (!isFinishing()) {
                            ...
                            if (mAdapter != null) {
                                ...
                                boolean isEmpty = mAdapter.isDataEmpty();
                                if (isEmpty) {
                                    showDataNull(getString(MResource.getIdentifier(getContext(),"string","picture_empty")), MResource.getIdentifier(getContext(),"drawable","picture_icon_no_data"));
                                } else {
                                    hideDataNull();
                                }
            ...
            showDataNull(getString(MResource.getIdentifier(getContext(),"string","picture_data_exception")), MResource.getIdentifier(getContext(),"drawable","picture_icon_data_error"));
            dismissDialog();
        }
    }
    ...
    private void initStandardModel(List<LocalMediaFolder> folders) {
        if (folders != null) {
            if (folders.size() > 0) {
                ...
                mTvPictureTitle.setTag(MResource.getIdentifier(getContext(),"id","view_count_tag"), folder.getImageNum());
    ...
    private void startCustomCamera() {
        if (PermissionChecker.checkSelfPermission(this, Manifest.permission.RECORD_AUDIO)) {
            ...
            overridePendingTransition(windowAnimationStyle.activityEnterAnimation, MResource.getIdentifier(getContext(),"anim","picture_anim_fade_in"));
        } else {
            PermissionChecker
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == MResource.getIdentifier(getContext(),"id","pictureLeftBack")
                || id == MResource.getIdentifier(getContext(),"id","picture_right")) {
        ...
        if (id == MResource.getIdentifier(getContext(),"id","picture_title") || id == MResource.getIdentifier(getContext(),"id","ivArrow") || id == MResource.getIdentifier(getContext(),"id","viewClickMask")) {
        ...
        if (id == MResource.getIdentifier(getContext(),"id","picture_id_preview")) {
            onPreview();
            return;
        }

        if (id == MResource.getIdentifier(getContext(),"id","picture_tv_ok") || id == MResource.getIdentifier(getContext(),"id","tv_media_num")) {
            onComplete();
            return;
        }

        if (id == MResource.getIdentifier(getContext(),"id","titleBar")) {
            if (config.isAutomaticTitleRecyclerTop) {
    ...
    private void onPreview() {
        ...
        overridePendingTransition(PictureSelectionConfig.windowAnimationStyle.activityPreviewEnterAnimation,
                MResource.getIdentifier(getContext(),"anim","picture_anim_fade_in"));
    }

    /**
     * Preview
     */
    private void onPreview(List<LocalMedia> list) {
//        List<LocalMedia> selectedData = mAdapter.getSelectedData();
//        List<LocalMedia> medias = new ArrayList<>();
//        int size = selectedData.size();
//        for (int i = 0; i < size; i++) {
...
//        }
        Bundle bundle = new Bundle();
        bundle.putParcelableArrayList(PictureConfig.EXTRA_PREVIEW_SELECT_LIST, (ArrayList<? extends Parcelable>) list);
        bundle.putParcelableArrayList(PictureConfig.EXTRA_SELECT_LIST, (ArrayList<? extends Parcelable>) list);
        bundle.putBoolean(PictureConfig.EXTRA_BOTTOM_PREVIEW, true);
        bundle.putBoolean(PictureConfig.EXTRA_CHANGE_ORIGINAL, config.isCheckOriginalImage);
        bundle.putBoolean(PictureConfig.EXTRA_SHOW_CAMERA, mAdapter.isShowCamera());
        bundle.putString(PictureConfig.EXTRA_IS_CURRENT_DIRECTORY, mTvPictureTitle.getText().toString());
        ...
        if (config.isWithVideoImage) {
            ...
            if (config.selectionMode == PictureConfig.MULTIPLE) {
                if (config.minSelectNum > 0) {
                    if (imageSize < config.minSelectNum) {
                        showPromptDialog(getString(MResource.getIdentifier(getContext(),"string","picture_min_img_num"), config.minSelectNum));
                        return;
                    }
                }
                if (config.minVideoSelectNum > 0) {
                    if (videoSize < config.minVideoSelectNum) {
                        showPromptDialog(getString(MResource.getIdentifier(getContext(),"string","picture_min_video_num"), config.minVideoSelectNum));
                        return;
                    }
                }
            }
            ...
            if (config.selectionMode == PictureConfig.MULTIPLE) {
                if (PictureMimeType.isHasImage(mimeType) && config.minSelectNum > 0 && size < config.minSelectNum) {
                    String str = getString(MResource.getIdentifier(getContext(),"string","picture_min_img_num"), config.minSelectNum);
                    showPromptDialog(str);
                    return;
                }
                if (PictureMimeType.isHasVideo(mimeType) && config.minVideoSelectNum > 0 && size < config.minVideoSelectNum) {
                    String str = getString(MResource.getIdentifier(getContext(),"string","picture_min_video_num"), config.minVideoSelectNum);
                    showPromptDialog(str);
                    return;
                }
            }
    ...
    private void AudioDialog(final String path) {
        if (!isFinishing()) {
            audioDialog = new PictureCustomDialog(getContext(), MResource.getIdentifier(getContext(),"layout","picture_audio_dialog"));
            if (audioDialog.getWindow() != null) {
                audioDialog.getWindow().setWindowAnimations(MResource.getIdentifier(getContext(),"style","Picture_Theme_Dialog_AudioStyle"));
            }
            mTvMusicStatus = audioDialog.findViewById(MResource.getIdentifier(getContext(),"id","tv_musicStatus"));
            mTvMusicTime = audioDialog.findViewById(MResource.getIdentifier(getContext(),"id","tv_musicTime"));
            musicSeekBar = audioDialog.findViewById(MResource.getIdentifier(getContext(),"id","musicSeekBar"));
            mTvMusicTotal = audioDialog.findViewById(MResource.getIdentifier(getContext(),"id","tv_musicTotal"));
            mTvPlayPause = audioDialog.findViewById(MResource.getIdentifier(getContext(),"id","tv_PlayPause"));
            mTvStop = audioDialog.findViewById(MResource.getIdentifier(getContext(),"id","tv_Stop"));
            mTvQuit = audioDialog.findViewById(MResource.getIdentifier(getContext(),"id","tv_Quit"));
            if (mHandler != null) {
    ...
    public class AudioOnClick implements View.OnClickListener {
        ...
        public void onClick(View v) {
            int id = v.getId();
            if (id == MResource.getIdentifier(getContext(),"id","tv_PlayPause")) {
                playAudio();
            }
            if (id == MResource.getIdentifier(getContext(),"id","tv_Stop")) {
                mTvMusicStatus.setText(getString(MResource.getIdentifier(getContext(),"string","picture_stop_audio")));
                mTvPlayPause.setText(getString(MResource.getIdentifier(getContext(),"string","picture_play_audio")));
                stop(path);
            }
            if (id == MResource.getIdentifier(getContext(),"id","tv_Quit")) {
                if (mHandler != null) {
    ...
    private void playAudio() {
        ...
        if (ppStr.equals(getString(MResource.getIdentifier(getContext(),"string","picture_play_audio")))) {
            mTvPlayPause.setText(getString(MResource.getIdentifier(getContext(),"string","picture_pause_audio")));
            mTvMusicStatus.setText(getString(MResource.getIdentifier(getContext(),"string","picture_play_audio")));
            playOrPause();
        } else {
            mTvPlayPause.setText(getString(MResource.getIdentifier(getContext(),"string","picture_play_audio")));
            mTvMusicStatus.setText(getString(MResource.getIdentifier(getContext(),"string","picture_pause_audio")));
            playOrPause();
        }
        if (!isPlayAudio) {
            if (mHandler != null) {
    ...
    public void onItemClick(int position, boolean isCameraFolder, long bucketId, String
        ...
        long currentBucketId = ValueOf.toLong(mTvPictureTitle.getTag(MResource.getIdentifier(getContext(),"id","view_tag")));
        mTvPictureTitle.setTag(MResource.getIdentifier(getContext(),"id","view_count_tag"), folderWindow.getFolder(position) != null
        ...
        mTvPictureTitle.setTag(MResource.getIdentifier(getContext(),"id","view_tag"), bucketId);
        folderWindow.dismiss();
    }
    ...
    private void setLastCacheFolderData() {
        int oldPosition = ValueOf.toInt(mTvPictureTitle.getTag(MResource.getIdentifier(getContext(),"id","view_index_tag")));
    ...
    private boolean isCurrentCacheFolderData(int position) {
        mTvPictureTitle.setTag(MResource.getIdentifier(getContext(),"id","view_index_tag"), position);
    ...
    public void onPictureClick(LocalMedia media, int position) {
        List<LocalMedia> media1 = new ArrayList<>();
        media1.add(media);
        onPreview(media1);
    }
    ...
    public void startPreview(List<LocalMedia> previewData, int position) {
        ...
        if (PictureMimeType.isHasVideo(mimeType)) {
            ...
            bundle.putBoolean(PictureConfig.EXTRA_CHANGE_ORIGINAL, config.isCheckOriginalImage);
            bundle.putBoolean(PictureConfig.EXTRA_SHOW_CAMERA, mAdapter.isShowCamera());
            bundle.putLong(PictureConfig.EXTRA_BUCKET_ID, ValueOf.toLong(mTvPictureTitle.getTag(MResource.getIdentifier(getContext(),"id","view_tag"))));
            bundle.putInt(PictureConfig.EXTRA_PAGE, mPage);
            bundle.putParcelable(PictureConfig.EXTRA_CONFIG, config);
            bundle.putInt(PictureConfig.EXTRA_DATA_COUNT, ValueOf.toInt(mTvPictureTitle.getTag(MResource.getIdentifier(getContext(),"id","view_count_tag"))));
            bundle.putString(PictureConfig.EXTRA_IS_CURRENT_DIRECTORY, mTvPictureTitle.getText().toString());
            JumpUtils.startPicturePreviewActivity(getContext(), config.isWeChatStyle, bundle,
                    config.selectionMode == PictureConfig.SINGLE ? UCrop.REQUEST_CROP : UCrop.REQUEST_MULTI_CROP);
            overridePendingTransition(PictureSelectionConfig.windowAnimationStyle.activityPreviewEnterAnimation, MResource.getIdentifier(getContext(),"anim","picture_anim_fade_in"));
        }
    }
        ...
        if (enable) {
            ...
            if (PictureSelectionConfig.uiStyle != null) {
                if (PictureSelectionConfig.uiStyle.picture_bottom_previewNormalText !=0) {
                    ...
                    mTvPicturePreview.setText(getString(MResource.getIdentifier(getContext(),"string","picture_preview_num"), selectData.size()));
                }
            } else if (PictureSelectionConfig.style != null) {
            ...
            if (numComplete) {
                ...
                if (PictureSelectionConfig.uiStyle != null) {
                    ...
                    mTvPictureOk.setText(getString(MResource.getIdentifier(getContext(),"string","picture_completed")));
                }
            ...
            if (PictureSelectionConfig.uiStyle != null) {
                if (PictureSelectionConfig.uiStyle.picture_bottom_previewDefaultText !=0) {
                    ...
                    mTvPicturePreview.setText(getString(MResource.getIdentifier(getContext(),"string","picture_preview")));
                }
            ...
            if (numComplete) {
                ...
                if (PictureSelectionConfig.uiStyle != null) {
                    ...
                    mTvPictureOk.setText(getString(MResource.getIdentifier(getContext(),"string","picture_please_select")));
                }
            }
        }
    }
    ...
    private void notifyAdapterData(LocalMedia media) {
        if (mAdapter != null) {
            ...
            if (folderWindow.getFolder(0) != null) {
                mTvPictureTitle.setTag(MResource.getIdentifier(getContext(),"id","view_count_tag"), folderWindow.getFolder(0).getImageNum());
            }
            allFolderSize = 0;
        }
    }
        ...
        if (config.isWithVideoImage) {
            ...
            if (PictureMimeType.isHasVideo(media.getMimeType())) {
                if (config.maxVideoSelectNum <= 0) {
                    showPromptDialog(getString(MResource.getIdentifier(getContext(),"string","picture_rule")));
                } else {
                    if (videoSize >= config.maxVideoSelectNum) {
                        showPromptDialog(getString(MResource.getIdentifier(getContext(),"string","picture_message_max_num"), config.maxVideoSelectNum));
                    } else {
        ...
        if (PictureMimeType.isHasVideo(media.getMimeType())) {
            if (config.videoMinSecond > 0 && config.videoMaxSecond > 0) {
                ...
                if (media.getDuration() < config.videoMinSecond || media.getDuration() > config.videoMaxSecond) {
                    isEnterNext = false;
                    showPromptDialog(getString(MResource.getIdentifier(getContext(),"string","picture_choose_limit_seconds"), config.videoMinSecond / 1000, config.videoMaxSecond / 1000));
                }
                ...
                if (media.getDuration() < config.videoMinSecond) {
                    isEnterNext = false;
                    showPromptDialog(getString(MResource.getIdentifier(getContext(),"string","picture_choose_min_seconds"), config.videoMinSecond / 1000));
                }
            } else if (config.videoMaxSecond > 0) {
                // Only the maximum length of video is set
                if (media.getDuration() > config.videoMaxSecond) {
                    isEnterNext = false;
                    showPromptDialog(getString(MResource.getIdentifier(getContext(),"string","picture_choose_max_seconds"), config.videoMaxSecond / 1000));
                }
            }
        }
        return isEnterNext;
        ...
        switch (requestCode) {
            ...
            case PictureConfig.APPLY_CAMERA_PERMISSIONS_CODE:
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    showPermissionsDialog(true, getString(MResource.getIdentifier(getContext(),"string","picture_camera")));
                }
                break;
            ...
            case PictureConfig.APPLY_RECORD_AUDIO_PERMISSIONS_CODE:
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    showPermissionsDialog(false, getString(MResource.getIdentifier(getContext(),"string","picture_audio")));
                }
                break;
        }
    }
    ...
    protected void showPermissionsDialog(boolean isCamera, String errorMsg) {
        ...
        final PictureCustomDialog dialog =
                new PictureCustomDialog(getContext(), MResource.getIdentifier(getContext(),"layout","picture_wind_base_dialog"));
        dialog.setCancelable(false);
        dialog.setCanceledOnTouchOutside(false);
        Button btn_cancel = dialog.findViewById(MResource.getIdentifier(getContext(),"id","btn_cancel"));
        Button btn_commit = dialog.findViewById(MResource.getIdentifier(getContext(),"id","btn_commit"));
        btn_commit.setText(getString(MResource.getIdentifier(getContext(),"string","picture_go_setting")));
        TextView tvTitle = dialog.findViewById(MResource.getIdentifier(getContext(),"id","tvTitle"));
        TextView tv_content = dialog.findViewById(MResource.getIdentifier(getContext(),"id","tv_content"));
        tvTitle.setText(getString(MResource.getIdentifier(getContext(),"string","picture_prompt")));
