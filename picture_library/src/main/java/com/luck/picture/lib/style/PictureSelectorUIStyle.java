...
public class PictureSelectorUIStyle {
     ...
     * @return
     */
    public static PictureSelectorUIStyle ofDefaultStyle(Context mContext) {
        ...
        uiStyle.picture_check_style = MResource.getIdentifier(mContext,"drawable","picture_checkbox_selector");

        uiStyle.picture_top_leftBack = MResource.getIdentifier(mContext,"drawable","picture_icon_back");
        ...
        uiStyle.picture_top_titleArrowUpDrawable = MResource.getIdentifier(mContext,"drawable","picture_icon_arrow_up");
        uiStyle.picture_top_titleArrowDownDrawable = MResource.getIdentifier(mContext,"drawable","picture_icon_arrow_down");
        ...
        uiStyle.picture_album_backgroundStyle = MResource.getIdentifier(mContext,"drawable","picture_item_select_bg");
        uiStyle.picture_album_textColor = Color.parseColor("#4d4d4d");
        uiStyle.picture_album_checkDotStyle = MResource.getIdentifier(mContext,"drawable","picture_orange_oval");
        ...
        uiStyle.picture_bottom_completeRedDotBackground = MResource.getIdentifier(mContext,"drawable","picture_num_oval");
        ...
        uiStyle.picture_adapter_item_camera_textTopDrawable = MResource.getIdentifier(mContext,"drawable","picture_icon_camera");

        uiStyle.picture_adapter_item_textSize = 12;
        uiStyle.picture_adapter_item_textColor = Color.parseColor("#FFFFFF");
        uiStyle.picture_adapter_item_video_textLeftDrawable = MResource.getIdentifier(mContext,"drawable","picture_icon_video");
        uiStyle.picture_adapter_item_audio_textLeftDrawable = MResource.getIdentifier(mContext,"drawable","picture_icon_audio");

        uiStyle.picture_bottom_originalPictureTextSize = 14;
        uiStyle.picture_bottom_originalPictureCheckStyle = MResource.getIdentifier(mContext,"drawable","picture_original_wechat_checkbox");
        uiStyle.picture_bottom_originalPictureTextColor = Color.parseColor("#FFFFFF");
        uiStyle.picture_bottom_previewNormalText = MResource.getIdentifier(mContext,"string","picture_preview_num");
        uiStyle.picture_bottom_originalPictureText = MResource.getIdentifier(mContext,"string","picture_original_image");
        uiStyle.picture_bottom_completeDefaultText = MResource.getIdentifier(mContext,"string","picture_please_select");
        uiStyle.picture_bottom_completeNormalText = MResource.getIdentifier(mContext,"string","picture_completed");
        uiStyle.picture_adapter_item_camera_text = MResource.getIdentifier(mContext,"string","picture_take_picture");
        uiStyle.picture_top_titleRightDefaultText = MResource.getIdentifier(mContext,"string","picture_cancel");
        uiStyle.picture_top_titleRightNormalText = MResource.getIdentifier(mContext,"string","picture_cancel");
        uiStyle.picture_bottom_previewDefaultText = MResource.getIdentifier(mContext,"string","picture_preview");
     ...
     * @return
     */
    public static PictureSelectorUIStyle ofSelectTotalStyle(Context mContext) {
        PictureSelectorUIStyle uiStyle = new PictureSelectorUIStyle();
        ...
        uiStyle.picture_top_leftBack = MResource.getIdentifier(mContext,"drawable","picture_icon_back_arrow");
        uiStyle.picture_top_titleRightTextColor = new int[]{Color.parseColor("#000000"), Color.parseColor("#000000")};
        uiStyle.picture_top_titleRightTextSize = 14;
        uiStyle.picture_top_titleTextSize = 18;
        uiStyle.picture_top_titleArrowUpDrawable = MResource.getIdentifier(mContext,"drawable","picture_icon_orange_arrow_up");
        uiStyle.picture_top_titleArrowDownDrawable = MResource.getIdentifier(mContext,"drawable","picture_icon_orange_arrow_down");
        ...
        uiStyle.picture_bottom_originalPictureTextSize = 14;
        uiStyle.picture_bottom_originalPictureCheckStyle = MResource.getIdentifier(mContext,"drawable","picture_original_checkbox");
        uiStyle.picture_bottom_originalPictureTextColor = Color.parseColor("#53575e");
        uiStyle.picture_bottom_previewNormalText = MResource.getIdentifier(mContext,"string","picture_preview_num");
        uiStyle.picture_bottom_originalPictureText = MResource.getIdentifier(mContext,"string","picture_original_image");
        uiStyle.picture_bottom_completeDefaultText = MResource.getIdentifier(mContext,"string","picture_done");
        uiStyle.picture_bottom_completeNormalText = MResource.getIdentifier(mContext,"string","picture_done_front_num");
        uiStyle.picture_adapter_item_camera_text = MResource.getIdentifier(mContext,"string","picture_take_picture");
        uiStyle.picture_top_titleRightDefaultText = MResource.getIdentifier(mContext,"string","picture_cancel");
        uiStyle.picture_top_titleRightNormalText = MResource.getIdentifier(mContext,"string","picture_cancel");
        uiStyle.picture_bottom_previewDefaultText = MResource.getIdentifier(mContext,"string","picture_preview");
     ...
     * @return
     */
    public static PictureSelectorUIStyle ofSelectNumberStyle(Context mContext) {
        PictureSelectorUIStyle uiStyle = new PictureSelectorUIStyle();
        ...
        uiStyle.picture_check_style = MResource.getIdentifier(mContext,"drawable","picture_checkbox_num_selector");
        ...
        uiStyle.picture_album_backgroundStyle = MResource.getIdentifier(mContext,"drawable","picture_item_select_bg");
        uiStyle.picture_album_textColor = Color.parseColor("#4d4d4d");
        uiStyle.picture_album_checkDotStyle = MResource.getIdentifier(mContext,"drawable","picture_num_oval_blue");
        ...
        uiStyle.picture_bottom_completeTextSize = 14;
        uiStyle.picture_bottom_completeRedDotTextColor = Color.parseColor("#FFFFFF");
        uiStyle.picture_bottom_completeRedDotBackground = MResource.getIdentifier(mContext,"drawable","picture_num_oval_blue");
        ...
        uiStyle.picture_bottom_originalPictureTextSize = 14;
        uiStyle.picture_bottom_originalPictureCheckStyle = MResource.getIdentifier(mContext,"drawable","picture_original_blue_checkbox");
     ...
     * @return
     */
    public static PictureSelectorUIStyle ofNewStyle(Context mContext) {
        PictureSelectorUIStyle uiStyle = new PictureSelectorUIStyle();
        ...
        uiStyle.picture_check_style = MResource.getIdentifier(mContext,"drawable","picture_wechat_num_selector");

        uiStyle.picture_top_leftBack = MResource.getIdentifier(mContext,"drawable","picture_icon_close");

        uiStyle.picture_top_titleRightTextColor = new int[]{Color.parseColor("#53575e"), Color.parseColor("#FFFFFF")};

        uiStyle.picture_top_titleRightTextSize = 14;
        uiStyle.picture_top_titleTextSize = 18;
        uiStyle.picture_top_titleArrowUpDrawable = MResource.getIdentifier(mContext,"drawable","picture_icon_wechat_up");
        uiStyle.picture_top_titleArrowDownDrawable = MResource.getIdentifier(mContext,"drawable","picture_icon_wechat_down");
        uiStyle.picture_top_titleTextColor = Color.parseColor("#FFFFFF");
        uiStyle.picture_top_titleBarBackgroundColor = Color.parseColor("#393a3e");
        uiStyle.picture_top_titleAlbumBackground = MResource.getIdentifier(mContext,"drawable","picture_album_bg");
        ...
        uiStyle.picture_bottom_originalPictureCheckStyle = MResource.getIdentifier(mContext,"drawable","picture_original_wechat_checkbox");
        uiStyle.picture_bottom_originalPictureTextColor = Color.parseColor("#FFFFFF");
        uiStyle.picture_top_titleRightTextDefaultBackground = MResource.getIdentifier(mContext,"drawable","picture_send_button_default_bg");
        uiStyle.picture_top_titleRightTextNormalBackground = MResource.getIdentifier(mContext,"drawable","picture_send_button_bg");

        IApp app = PictureAppMaster.getInstance().getApp();
        Context appContext = app.getAppContext();
        if (appContext != null) {
            uiStyle.picture_top_titleBarHeight = ScreenUtils.dip2px(appContext, 48);
            uiStyle.picture_top_titleRightDefaultText = MResource.getIdentifier(mContext,"string","picture_send");
            uiStyle.picture_top_titleRightNormalText = MResource.getIdentifier(mContext,"string","picture_cancel");
            uiStyle.picture_bottom_barHeight = ScreenUtils.dip2px(appContext, 45);
            uiStyle.picture_bottom_previewDefaultText = MResource.getIdentifier(mContext,"string","picture_preview");
            uiStyle.picture_bottom_previewNormalText = MResource.getIdentifier(mContext,"string","picture_preview_num");
            ...
            uiStyle.picture_bottom_completeNormalText = MResource.getIdentifier(mContext,"string","picture_completed");
            uiStyle.picture_adapter_item_camera_text = MResource.getIdentifier(mContext,"string","picture_take_picture");
            uiStyle.picture_bottom_selectedText = MResource.getIdentifier(mContext,"string","picture_select");
            uiStyle.picture_bottom_selectedCheckStyle = MResource.getIdentifier(mContext,"drawable","picture_wechat_select_cb");
            // 如果文本内容设置(%1$d/%2$d)，请开启true
            uiStyle.isCompleteReplaceNum = true;
            ...
            uiStyle.picture_bottom_gallery_frameBackground = MResource.getIdentifier(mContext,"drawable","picture_preview_gallery_border_bg");
        }
