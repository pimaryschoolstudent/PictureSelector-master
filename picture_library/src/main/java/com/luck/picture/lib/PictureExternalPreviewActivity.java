...
public class PictureExternalPreviewActivity extends PictureBaseActivity implements View.OnClickListener {
    ...
    public int getResourceId() {
        return MResource.getIdentifier(getContext(),"layout","picture_activity_external_preview");
    }
    ...
    protected void initWidgets() {
        ...
        ibLeftBack = findViewById(MResource.getIdentifier(getContext(),"id","left_back"));
        ibDelete = findViewById(MResource.getIdentifier(getContext(),"id","ib_delete"));
    ...
    public void initPictureSelectorStyle() {
        if (PictureSelectionConfig.style != null) {
            ...
            int previewBgColor = AttrsUtils.getTypeValueColor(getContext(), MResource.getIdentifier(getContext(),"attr","picture_ac_preview_title_bg"));
            if (previewBgColor != 0) {
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == MResource.getIdentifier(getContext(),"id","left_back")) {
            finish();
            exitAnimation();
        } else if (id == MResource.getIdentifier(getContext(),"id","ib_delete")) {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (contentView == null) {
                contentView = LayoutInflater.from(container.getContext())
                        .inflate(MResource.getIdentifier(getContext(),"layout","picture_image_preview"), container, false);
                mCacheView.put(position, contentView);
            }
            // 常规图控件
            final PhotoView imageView = contentView.findViewById(MResource.getIdentifier(getContext(),"id","preview_image"));
            // 长图控件
            final SubsamplingScaleImageView longImageView = contentView.findViewById(MResource.getIdentifier(getContext(),"id","longImg"));
            // 视频播放按钮
            ImageView ivPlay = contentView.findViewById(MResource.getIdentifier(getContext(),"id","iv_play"));
    ...
    private void showDownLoadDialog() {
        if (!isFinishing() && !TextUtils.isEmpty(downloadPath)) {
            ...
            tv_content.setText(getString(MResource.getIdentifier(getContext(),"string","picture_prompt_content")));
            ...
            btn_commit.setOnClickListener(view -> {
                ...
                if (isHttp) {
                    ...
                    try {
                        ...
                        ToastUtils.s(getContext(), getString(MResource.getIdentifier(getContext(),"string","picture_save_error")) + "\n" + e.getMessage());
                        dismissDialog();
                        e.printStackTrace();
                    }
                }
    ...
    private void onSuccessful(String result) {
        ...
        if (!TextUtils.isEmpty(result)) {
            try {
                ...
                ToastUtils.s(getContext(), getString(MResource.getIdentifier(getContext(),"string","picture_save_success")) + "\n" + result);
            } catch (Exception e) {
                e.printStackTrace();
            }
        } else {
    ...
    private void exitAnimation() {
        overridePendingTransition(MResource.getIdentifier(getContext(),"anim","picture_anim_fade_in"), PictureSelectionConfig.windowAnimationStyle.activityPreviewExitAnimation);
    }
        ...
        if (requestCode == PictureConfig.APPLY_STORAGE_PERMISSIONS_CODE) {// 存储权限
            for (int grantResult : grantResults) {
                if (grantResult == PackageManager.PERMISSION_GRANTED) {
                    ...
                    ToastUtils.s(getContext(), getString(MResource.getIdentifier(getContext(),"string","picture_jurisdiction")));
                }
            }
        }
    }
