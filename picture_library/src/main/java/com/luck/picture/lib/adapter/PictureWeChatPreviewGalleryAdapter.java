...
public class PictureWeChatPreviewGalleryAdapter
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(MResource.getIdentifier(parent.getContext(),"layout","picture_wechat_preview_gallery"), parent, false);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            ivImage = itemView.findViewById(MResource.getIdentifier(itemView.getContext(),"id","ivImage"));
            ivPlay = itemView.findViewById(MResource.getIdentifier(itemView.getContext(),"id","ivPlay"));
            viewBorder = itemView.findViewById(MResource.getIdentifier(itemView.getContext(),"id","viewBorder"));
