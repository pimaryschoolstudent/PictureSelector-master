...
public final class PictureMimeType {
    ...
    public static String s(Context context, String mimeType) {
        ...
        if (isHasVideo(mimeType)) {
            return ctx.getString(MResource.getIdentifier(context,"string","picture_video_error"));
        } else if (isHasAudio(mimeType)) {
            return ctx.getString(MResource.getIdentifier(context,"string","picture_audio_error"));
        } else {
            return ctx.getString(MResource.getIdentifier(context,"string","picture_error"));
        }
    }
