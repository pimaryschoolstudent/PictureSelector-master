...
public class PictureVideoPlayActivity extends PictureBaseActivity implements
    ...
    public int getResourceId() {
        return MResource.getIdentifier(this,"layout","picture_activity_video_play");
    }
    ...
    protected void initWidgets() {
        ...
        ibLeftBack = findViewById(MResource.getIdentifier(this,"id","pictureLeftBack"));
        mVideoView = findViewById(MResource.getIdentifier(this,"id","video_view"));
        tvConfirm = findViewById(MResource.getIdentifier(this,"id","tv_confirm"));
        mVideoView.setBackgroundColor(Color.BLACK);
        iv_play = findViewById(MResource.getIdentifier(this,"id","iv_play"));
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == MResource.getIdentifier(this,"id","pictureLeftBack")) {
            onBackPressed();
        } else if (id == MResource.getIdentifier(this,"id","iv_play")) {
            mVideoView.start();
            iv_play.setVisibility(View.INVISIBLE);
        } else if (id == MResource.getIdentifier(this,"id","tv_confirm")) {
