    ...
    private String getCaptureTip() {
        ...
        switch (buttonFeatures) {
            case BUTTON_STATE_ONLY_CAPTURE:
                return getContext().getString(MResource.getIdentifier(getContext(),"string","picture_photo_pictures"));
            case BUTTON_STATE_ONLY_RECORDER:
                return getContext().getString(MResource.getIdentifier(getContext(),"string","picture_photo_recording"));
            default:
                return getContext().getString(MResource.getIdentifier(getContext(),"string","picture_photo_camera"));
        }
    }
