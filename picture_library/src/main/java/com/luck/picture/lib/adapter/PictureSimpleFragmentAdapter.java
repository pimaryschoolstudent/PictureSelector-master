    ...
    public Object instantiateItem(@NotNull ViewGroup container, int position) {
        ...
        if (contentView == null) {
            contentView = LayoutInflater.from(container.getContext())
                    .inflate(MResource.getIdentifier(container.getContext(),"layout","picture_image_preview"), container, false);
            mCacheView.put(position, contentView);
        }
        PhotoView imageView = contentView.findViewById(MResource.getIdentifier(container.getContext(),"id","preview_image"));
        SubsamplingScaleImageView longImg = contentView.findViewById(MResource.getIdentifier(container.getContext(),"id","longImg"));
        ImageView ivPlay = contentView.findViewById(MResource.getIdentifier(container.getContext(),"id","iv_play"));
