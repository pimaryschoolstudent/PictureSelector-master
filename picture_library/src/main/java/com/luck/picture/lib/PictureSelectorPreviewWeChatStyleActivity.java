...
public class PictureSelectorPreviewWeChatStyleActivity extends PicturePreviewActivity {
    ...
    public int getResourceId() {
        return MResource.getIdentifier(getContext(),"layout","picture_wechat_style_preview");
    }
    ...
    protected void initWidgets() {
        super.initWidgets();
        goneParent();
        mRvGallery = findViewById(MResource.getIdentifier(getContext(),"id","rv_gallery"));
        bottomLine = findViewById(MResource.getIdentifier(getContext(),"id","bottomLine"));
        ...
        mTvSelected = findViewById(MResource.getIdentifier(getContext(),"id","tv_selected"));
    ...
    private boolean isEqualsDirectory(String parentFolderName, String currentDirectory) {
        return isBottomPreview
                ...
                || currentDirectory.equals(getString(MResource.getIdentifier(getContext(),"string","picture_camera_roll")))
    ...
    public void initPictureSelectorStyle() {
        ...
        if (PictureSelectionConfig.uiStyle != null) {
            ...
            if (PictureSelectionConfig.uiStyle.picture_bottom_barBackgroundColor != 0) {
                ...
                selectBarLayout.setBackgroundColor(ContextCompat.getColor(getContext(), MResource.getIdentifier(getContext(),"color","picture_color_half_grey")));
            }
            ...
            if (PictureSelectionConfig.uiStyle.picture_bottom_selectedCheckStyle != 0) {
                ...
                check.setBackgroundResource(MResource.getIdentifier(getContext(),"drawable","picture_wechat_select_cb"));
            }
            ...
            if (PictureSelectionConfig.uiStyle.picture_top_leftBack != 0) {
                ...
                pictureLeftBack.setImageResource(MResource.getIdentifier(getContext(),"drawable","picture_icon_back"));
            }
            ...
            if (config.isOriginalControl) {
                if (PictureSelectionConfig.uiStyle.picture_bottom_originalPictureText !=0) {
                    ...
                    mCbOriginal.setText(getString(MResource.getIdentifier(getContext(),"string","picture_original_image")));
                }
                ...
                if (PictureSelectionConfig.uiStyle.picture_bottom_originalPictureCheckStyle != 0) {
                    ...
                    mCbOriginal.setButtonDrawable(MResource.getIdentifier(getContext(),"drawable","picture_original_wechat_checkbox"));
                }
            }
        ...
        if (config.isWithVideoImage) {
            ...
            if (config.selectionMode == PictureConfig.SINGLE) {
                ...
                if (isCompleteReplaceNum && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureCompleteText)) {
                    ...
                    mTvPictureRight.setText(isNotEmptyStyle && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureUnCompleteText)
                            ? PictureSelectionConfig.style.pictureUnCompleteText : getString(MResource.getIdentifier(getContext(),"string","picture_send_num"), selectData.size(),
                            config.maxSelectNum));
                }
            }
        } else {
            ...
            if (config.selectionMode == PictureConfig.SINGLE) {
                ...
                if (isCompleteReplaceNum && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureCompleteText)) {
                    ...
                    mTvPictureRight.setText(isNotEmptyStyle && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureUnCompleteText)
                            ...
                            : getString(MResource.getIdentifier(getContext(),"string","picture_send_num"), selectData.size(), maxSize));
                }
            }
        }
    }
