        ...
        if (isEnterSetting) {
            ...
            if (isExternalStorage) {
                ...
                if (isCameraPermissionChecker) {
                    ...
                    showPermissionsDialog(false, getString(MResource.getIdentifier(getContext(),"string","picture_camera")));
                }
            } else {
        ...
        switch (requestCode) {
            case PictureConfig.APPLY_STORAGE_PERMISSIONS_CODE:
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    showPermissionsDialog(true, getString(MResource.getIdentifier(getContext(),"string","picture_jurisdiction")));
                }
                break;
