...
//        PictureCustomDialog dialog = new PictureCustomDialog(getContext(), MResource.getIdentifier(getContext(),"layout","picture_prompt_dialog"));
//        TextView btnOk = dialog.findViewById(MResource.getIdentifier(getContext(),"id","btnOk"));
//        TextView tvContent = dialog.findViewById(MResource.getIdentifier(getContext(),"id","tv_content"));
//        tvContent.setText("123");
...
//        dialog.show();
        ...
        mSelectorUIStyle = PictureSelectorUIStyle.ofDefaultStyle(getContext());
                ...
                switch (mediaType) {
                    case PictureConfig.TYPE_VIDEO:
                        ...
                        PictureSelector.create(MainActivity.this)
                                ...
                                .setPictureStyle(mPictureParameterStyle,getContext())// 动态自定义相册主题
    ...
    public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
        switch (checkedId) {
            ...
            case R.id.rb_white_style:
                ...
                mSelectorUIStyle = PictureSelectorUIStyle.ofSelectTotalStyle(getContext());
                break;
            case R.id.rb_num_style:
                themeId = R.style.picture_QQ_style;
                isWeChatStyle = false;
                mPictureParameterStyle = getNumStyle();
                mSelectorUIStyle = PictureSelectorUIStyle.ofSelectNumberStyle(getContext());
                break;
            ...
            case R.id.rb_we_chat_style:
                ...
                mSelectorUIStyle = PictureSelectorUIStyle.ofNewStyle(getContext());
                break;
